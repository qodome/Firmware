...
__attribute__ ((section(".bootloader_settings_sect"))) uint8_t m_boot_settings[1024] ;
__attribute__ ((section(".NRF_UICR_BOOT_START_SECT"))) uint32_t m_uicr_bootloader_start_address = BOOTLOADER_REGION_START;
