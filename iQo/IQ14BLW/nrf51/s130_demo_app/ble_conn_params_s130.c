...
static void init_preferred_conn_params(void)
{
    ...
    uint32_t err_code = sd_ble_gap_ppcp_get(&m_preferred_conn_params);
    if (err_code != NRF_SUCCESS) {
        m_preferred_conn_params.min_conn_interval = m_conn_params_config.secondary_min_conn_interval;
        m_preferred_conn_params.max_conn_interval = m_conn_params_config.secondary_max_conn_interval;
        m_preferred_conn_params.slave_latency = m_conn_params_config.secondary_slave_latency;
        m_preferred_conn_params.conn_sup_timeout = m_conn_params_config.secondary_conn_sup_timeout;
    }
}
