 ...
 */
   ...
   *               0 seconds, on the 1st of January 2014 UTC
   */
  ...
  extern UTCTime osal_getRelativeClock(void);
  ...
  /*
   * Converts UTCTimeStruct to UTCTime (seconds since 00:00:00 01/01/2014)
   *
  ...
  extern uint8 osal_TimeInitialized(void);
