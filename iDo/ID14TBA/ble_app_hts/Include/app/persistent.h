...
#define PERSISTENT_ERROR_TIMER1			(6 + PERSISTENT_ERROR_SYS_MAX)
#define PERSISTENT_ERROR_TIMER2			(7 + PERSISTENT_ERROR_SYS_MAX)
#define PERSISTENT_ERROR_ADXL362		(8 + PERSISTENT_ERROR_SYS_MAX)
