...
static void gpiote_init(void)
{
    ...
    retval = app_gpiote_user_register(&m_gpio_uid, low_to_high_bitmask, high_to_low_bitmask, ecg_gpiote_event_handler);
    APP_ERROR_CHECK(retval);

    retval = app_gpiote_user_enable(m_gpio_uid);
    APP_ERROR_CHECK(retval);
}
...
static void acc_spi_init(void)
{
    ...
    spi_config.SPI_Pin_SCK = 30;
    spi_config.SPI_Pin_MISO = 27;
    spi_config.SPI_Pin_MOSI = 29;
    spi_config.SPI_Pin_SS = 26;
